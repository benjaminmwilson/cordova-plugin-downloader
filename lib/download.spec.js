...
global.window = {
    resolveLocalFileSystemURL :  function (fileSystem, success, error) {
        ...
        if(resolveLocalFileSystemURLCount++ === 0) {
            ...
            setTimeout(function() { success(parentEntry); }, 0); //simulate async
        }
        else {
            //console.log("fake resolveLocalFileSystemURL 2");
            setTimeout(function() { success(deleteFileEntry); }, 0); //simulate async
        }
...
describe('download module', function () {
    ...
    describe('download.Get', function () {
        ...
        it('should get a URL using XMLHttpRequest and unzip the downloaded file using Cordova zip plugin', function (done) {
            ...
            dlConfig.success = function() {

                dlConfig.error.should.not.have.been.called;
